...
public class Notes_7_3_Examples {
    public static void main(String[] args) {
        ...
        System.out.println("vals ArrayList: " + vals);

        // Call countEvens and print the result

        System.out.println("Num evens (regular for loop): " + countEvens(vals));

        // Call countEvensForEach and print the result

        System.out.println("Num evens (for each loop): " + countEvensForEach(vals));
        ...
        System.out.println("list2 ArrayList: " + list2);
        ...
        System.out.println("list1 removeEvensForward: " + list1);
        ...
        System.out.println("list2 removeEvensBackward: " + list2);
        ...
        System.out.println("vals removeEvensForward: " + vals);

        // Did this method work as intended?  Why or why not?

        // No, the index changes as size decreases; when an object is removed, the ArrayList's size is decremented by 1 and the for loop is ended prematurely
        // before the loop runs as intended
